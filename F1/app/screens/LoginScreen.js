...
export default function LoginScreen({ navigation, expoClientIdValue, iosClientIdVal, androidClientIdVal }) {
  ...
  const [request, response, promptAsync] = Google.useAuthRequest({
    ...
    // iosClientId: iosClientIdVal,
    // androidClientId: androidClientIdVal,
    clientId : {
      ios: iosClientIdVal,
      android: androidClientIdVal
    }
  });
  ...
  const handleLogin = async () => {
    ...
    const url = `http://192.168.1.71:9000/users/login`;
    try {
